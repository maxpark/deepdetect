    ...
    for (size_t label = 1; label < _nclasses; ++label)
      {
        ...
        // debug
        /*std::cerr << "tp_d=" << eval_infos[label].tp_d
                  << " / tp_i=" << eval_infos[label].tp_i
                  << " / fp_d=" << eval_infos[label].fp_d
                  << " / fp_i=" << eval_infos[label].fp_i << std::endl;
        std::cerr << "num_pos=" << eval_infos[label].num_pos
